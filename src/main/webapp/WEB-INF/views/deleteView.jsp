...
<section>
    ...
    <form class="row g-3" action="deleteDetails" modelAttribute="employee" method="post">
        ...
        <%--<div class="col-6" >
            <button id="deleteBtn" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" type="button" value="Delete" style="
    margin-left: 83%;">
            </button>
        </div>--%>
        <div class="col-6">
