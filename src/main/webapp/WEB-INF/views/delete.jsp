...
<section class="hero">
    ...
    <h2  class="header">Delete Employees</h2>
</section>
...
<div class="content">
    ...
    <form class="needs-validation" action="deleteEmployeeForm" method="post" novalidate>

        <label for="searchEmail" class="form-label">Search by Email</label>
        <input type="email" class="form-control" id="searchEmail" name="searchEmail" placeholder="abc@gmail.com" required>
